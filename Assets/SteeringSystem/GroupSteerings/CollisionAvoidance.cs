...
namespace SteeringSystem
{
    ...
    {
        [SerializeField] private GroupAvoidanceManager m_behaviourManager;
        ...
        protected override void Awake()
        {
            ...
            if (!m_behaviourManager)
            {
                m_behaviourManager = FindObjectOfType<GroupAvoidanceManager>();
            }
        }
        ...
        protected override SteeringOutput GetSteering()
        {
            ...
            */
            ...
            return SteeringOutput.Clip(m_entity[GroupBehaviour.CollisionAvoidance], m_maxLinearAcceleration, m_maxAngularAcceleration);
        }
    }
}